...
pubDate: 2025-11-23
heroImage: '../../assets/writing/my-homelab-my-rules/cover.png'
---
...
![Physical Image 1](../../assets/writing/my-homelab-my-rules/physical-server-1.jpeg)
![Physical Image 2](../../assets/writing/my-homelab-my-rules/physical-server-2.jpeg)
...
![Homelab network diagram showing virtual network 10.20.30.0/24 with IPFire VM 101, Pi-hole LXC 201, and Docker VM 100 containing Traefik reverse proxy routing to Immich, Vaultwarden, n8n, File Browser, Stirling-PDF, OmniTools, and CouchDB on Docker bridge network 192.168.204.0/24](../../assets/writing/my-homelab-my-rules/home-lab-secure-access-architecture.png)
...
Google Photos is convenient until it isn't. Until they change a policy. Until they lock an account. Until your entire visual history depends on a corporation's mood.

Immich lives on my HDD. No charges. No compression. No unknown eyes.
...
No breach headlines. No tracking. And it gives me **Bitwarden premium features (TOTP!)** without the premium price.
...
Cloud automation tools treat you like a child: "You've hit your free limit." "You can run only X workflows." "Upgrade to Pro."
...
There's an extension called "Self-hosted LiveSync" that syncs Obsidian via CouchDB.

I added a CouchDB Docker container. Connected it. And my notes sync faster than most paid sync services.

Also: Zero cloud. Zero tracking. Zero dependency.
...
It wasn't built with expensive hardware. It wasn't built with enterprise gear. It wasn't built because I "needed" it.
...
But honestly? Even if I never upgrade anything, this setup already gives me something priceless:
